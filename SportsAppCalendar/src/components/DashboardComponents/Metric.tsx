...
function UsersM({ title, value }: { title?: string; value?: number }) {
  ...
  return (
    <div className="h-40 w-72 flex items-center justify-start flex-col gap-6 bg-gray-100 border border-t-2 border-l-2 border-gray-500 rounded-lg shadow-md p-4 pt-0 font-sans antialiased">
